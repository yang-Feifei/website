$$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫杨菲菲，是一个前端开发工程师</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是解决用户的交互体验,擅长图形交互与数据展示等</div>",2000);
	...
	w.load("<p><div class='writecode'>杨菲菲</div>");
	w.load("<div class='writecode'>前端开发工程师</div>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:per_yangfeifei@163.com</li>");
	w.load("<li class='writecode'>blog:<a href='http://yang-feifei.github.io' target='_blank'>http://yang-feifei.github.io</a></li>");
	w.load("<li class='writecode'>作品:<a href='https://yangfeifei9.github.io' target='_blank'>https://yangfeifei9.github.io</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>web 开发：熟悉 htmltcsstjavascript 三大前端语言,且能熟练运用 jquery 框架实现网页常用特效,掌握面向对象编程思想;</li>");
	w.load("<li class='writecode'>前端框架：熟悉vue 了解 react angular 主流框架,熟悉 ant design/ element ui / vantui 等组件库的使用;</li>");
	w.load("<li class='writecode'>可视化：three.js,echarts</li>");
	w.load("<li class='writecode'>打包工具：简单使用过webpack 可以对jis,css,img 等资源进行打包;</li>");
	w.load("<li class='writecode'>版本管理：熟悉使用 Git 工具进行协同开发,团队配合意识良好;</li>");
	w.load("<li class='writecode'>算法：懂的基本的算法(排序算法,链表,栈);</li>");
	w.load("<li class='writecode'>网络：了解 HTTP 协议；熟悉 w3C 标准,对表现与数据分离 web 语义化等有深刻理解;</li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
